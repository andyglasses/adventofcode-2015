function run(){
  var lines =  getInput().trim().split('\n').map(function(x) { return x.trim(); })
  var total = 0;
  lines.forEach(l =>
  {
    var length = l.length;
    var end = l;
    end = end.replaceAll('"', 'xx');
    end = end.replaceAll('\\', 'xx')
    var endLEngth = end.length + 2;
    total += endLEngth - length;
    console.log(endLEngth - length, l, end, l.length, endLEngth);
  })
  console.log(total);
}
